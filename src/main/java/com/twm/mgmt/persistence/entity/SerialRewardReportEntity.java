...
@Data
@Table(name = "SERIAL_REWARD_REPORT", schema = MoDbConfig.REWARD_SCHEMA)
@Entity
@SuppressWarnings("serial")
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SerialRewardReportEntity implements Serializable {
