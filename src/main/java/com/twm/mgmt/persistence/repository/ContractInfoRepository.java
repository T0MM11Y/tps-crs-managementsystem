...
public interface ContractInfoRepository
		extends JpaRepository<ContractInfoEntity, com.twm.mgmt.persistence.entity.pk.ContractInfoPk> {
	...
	BigDecimal getContractId(@Param("projectSeqNbr") String projectSeqNbr, @Param("projectCode") String projectCode,
	...
	String getMomoMemberId(@Param("projectSeqNbr") String projectSeqNbr, @Param("projectCode") String projectCode,
			@Param("subid") String subid, @Param("contractId") BigDecimal contractId);
	...
	BigDecimal getContractId(@Param("projectSeqNbr") String projectSeqNbr, @Param("projectCode") String projectCode,
			@Param("subid") String subid, @Param("momoMemberId") String momoMemberId);
